...
function my_login_logo_one() { 
	...
	body.login div#login h1 a {
	 background-image: url("<?php echo get_stylesheet_directory_uri();?>/images/inhabitent-logo-tent.svg");
	padding-bottom: 30px; 
	} 
	</style>
	 <?php 
...
add_filter('login_headerurl','my_login_login_url');
function my_login_login_url($url)
{
	// return home_url();
